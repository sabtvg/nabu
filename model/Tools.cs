...
namespace nabu
{
    ...
    public static class Tools
    {
        ...
        public static List<string> dictionary = new List<string>() {
            ...
            "SubGrupo.eliminado.tip|ct|Grup de treball eliminat de l'estructura organitzativa",
            "SubGrupo.eliminado.titulo|ct|Grup de treball eliminat de l'estructura organitzativa",
            ...
            "Sobre la publicacion|es|About the publication",
