...
namespace nabu
{
    ...
    public static class Tools
    {
        ...
        public static DateTime toDate(string s, string idioma)
        {
            ...
            try
            {
                ...
                if (idioma == "es" || idioma == "fr" || idioma == "ct")
                {
                    //dd/MM/yy
                    string[] p = s.Split(sep);
                    ret = new DateTime(Convert.ToInt32(p[2]),
                        Convert.ToInt32(p[1]),
                        Convert.ToInt32(p[0]));
                }
                else
            ...
            {
                throw new Exception(tr("Fecha invalida", idioma) + ": " + s);
            }
            return ret;
        }
        ...
        public static List<string> dictionary = new List<string>() {
            ...
            "Aclaracion|es|Aclaraci&oacute;n",
            ...
            "SubGrupo.eliminado|es|Grupo de trabajo [%1] eliminado de la estructura organizativa",
            ...
            "evento.aquien.tip|es|Vers qui l&#x2019;&eacute;v&eacute;nement est orient&eacute;, et qui sera b&eacute;n&eacute;fici&eacute; par les r&eacute;sultats?",
            ...
            "subGrupo.consensoMsg|es|Se ha aprobado la actualizacion de un subgrupo <br>y ya esta disponible en las estructuras",
            "Fallo al enviar el mail|es|Fallo al enviar el mail: ",
            "El mail del coordinador es incorrecto|es|El mail del coordinador es incorrecto: ",
            "Comunicado del grupo|es|Comunicado del grupo",
            "Al grupo padre|es|Al grupo padre",
            "Sobre la publicacion|es|Sobre la publicaci&oacute;n",
            "modeloDocumento.Accion|es|Acci&oacute;n",
            "modeloDocumento.Acta|es|Acta",
            "modeloDocumento.AlHijo|es|GrupoConcreto",
            "modeloDocumento.AlPadre|es|GrupoGeneral",
            "modeloDocumento.Circular|es|Circular",
            "modeloDocumento.Didactico|es|Did&aacute;ctico",
            "modeloDocumento.Estrategia|es|Estrat&eacute;gia",
            "modeloDocumento.Evento|es|Evento",
            "modeloDocumento.Manifiesto|es|Manifiesto",
            "modeloDocumento.SubGrupo|es|Subgrupo",
            "modeloEvaluacion.Accion|es|Accion",
            "modeloEvaluacion.AlHijo|es|GrupoConcreto",
            "modeloEvaluacion.AlPadre|es|GrupoGeneral",
            "modeloEvaluacion.Enlace|es|Enlace",
            "modeloEvaluacion.Evento|es|Evento",


            "(Aparece en el pie del arbol)|ct|(Apareix al peu de l'arbre)",
            "(Etiqueta en el arbol)|ct|(Etiqueta a l'arbre)",
            "accion|ct|Acci&oacute;",
            "Accion finalizada [%1]|ct|Acci— finalitzada",
            "accion.aquien.tip|ct|Qui es beneficiar&agrave; amb els resultats",
            "accion.aquien.titulo|ct|A qui va dirigit",
            "accion.creada|ct|Acció Creada",
            ...
            "accion.error|ct|Error",
            "accion.evaluacion.p1|ct|&iquest;Creus que la nostra acció concreta ha facilitat el desenvolupament dels nuestres objetius? Si no, &iquest;per qu&egrave;?",
            "accion.evaluacion.p2|ct|&iquest;Hem aprs algo nou de lÕexperincia? Si es que si, &iquest;Qu; ha estat? Si Žs que no, &iquest;Qu; creus que ha frenat el nuestre procŽs dÕaprenentatge?",
            "accion.evaluacion.p3|ct|&iquest;T'has sentit segur, inclòs, participatiu durant el procés? si no, &iquest;Per qu&eacute;?",
            "accion.evaluacion.p4|ct|&iquest;Las fases, costos, recursos i terminis han estat els adequats? Si no, &iquest;Per qu&eacute;?",
            "accion.evaluacion.p5|ct|&iquest;Creus que la persona que ha coordinat el procés ha estat conseqüent con suamb el seu rol? Si no, &iquest;Per qu&egrave;?",
            "accion.evaluacion.p6|ct|&iquest;Creus que es requereix un altre cicle d'Acci&oacute; per resoldre aquest tema? Si és que si, &iquest;Per qu&egrave;?",
            "accion.evaluacion.tip1|ct|Eval&uacute;a si l'Acci&oacute; era necessaria com s'habia definit al prendre la decisi&oacute;",
            "accion.evaluacion.tip2|ct|Eval&uacute;a si l'objectiu definit en l'Acci&oacute; finalment es correspon amb el resultat obtingut",
            "accion.evaluacion.tip3|ct|Eval&uacute;a si t'has sentit segur, i coparticipatiu del procés executiu",
            "accion.evaluacion.tip4|ct|Eval&uacute;a si les fases, costos, recursos i terminis definits al prendre la decis&oacute; eren adequats",
            "accion.evaluacion.tip5|ct|Eval&uacute;a si la persona que ha coordinat el procés, ho feu adequadament",
            "accion.evaluacion.tip6|ct|Eval&uacute;a si consideres necessari realitzar un atre cicle de debat i Acci&oacute; tenint en compte el resultat obtingut",
            ...
            "accion.presupuesto.titulo|ct|Pressopost i termini d'entrega",
            "accion.responsable.tip|ct||Responsable de progecte",
            "accion.responsable.titulo|ct|Responsable",
            "accion.revision.tip|ct|Revisi&oacute;",
            ...
            "acta.apertura.titulo|ct|Ronda d'obertura",
            "acta.evaluacion.tip|ct|",
            "acta.evaluacion.titulo|ct|Evaluaci&oacute;",
            "acta.logisticos.tip|ct|",
            "acta.logisticos.titulo|ct|Aspectes log&iacute;stics",
            "acta.ordendeldia.tip|ct|",
            "acta.ordendeldia.titulo|ct|Ordre del dia",
            "Agregar tema|ct|Agregar tema",
            "alhijo.evaluacion.p1|ct|&iquest;El problema a tractar est&aacute; ben definit?",
            "alhijo.evaluacion.p2|ct|&iquest;La situaci&oacute; actual es correspon amb la realitat?",
            "alhijo.evaluacion.p3|ct|&iquest;La proposta hauria d'analitzar-se?",
            "alhijo.evaluacion.p4|ct|&iquest;La situaci&oacute; desitjada és assumible?",
            "alhijo.evaluacion.p5|ct|&iquest;Aquest tema hauria d'atendre's en aquest grup?",
            ...
            "alhijo.introduccion.tip|ct|Quina ser&iacute;a la nostra motivaci&oacute; per enviar aquest document de feedback",
            "alhijo.introduccion.titulo|ct|Introducci&oacute;",
            "evento.organizacion.fecha|ct|Data",
            "alhijo.propuesta.tip|ct|Quina és la proposta a tenir en compta pel grup fill",
            "alhijo.propuesta.titulo|ct|Proposta",
            "alhijo.situacionactual.tip|ct|Descrigui la situaci&oacute; actual general",
            "alhijo.situacionactual.titulo|ct|Situaci&oacute; actual",
            "alhijo.situaciondeseada.tip|ct|Descrigui la situaci&oacute; desitjada que volem veure considerada pel grup fill",
            "alhijo.situaciondeseada.titulo|ct|Situaci&oacute; desitjada",
            "alpadre.evaluacion.p1|ct|&iquest;El problema a tractar est&atilde;; ben definit?",
            "alpadre.evaluacion.p2|ct|&iquest;La situaci&oacute; actual es correspon amb la realitat?",
            "alpadre.evaluacion.p3|ct|&iquest;La proposta hauria d'analizar-se?",
            "alpadre.evaluacion.p4|ct|&iquest;La situaci&oacute; desitjada és assumible?",
            "alpadre.evaluacion.p5|ct|&iquest;Aquest tema hauria d'atendre's en aquest grup?",
            ...
            "alpadre.introduccion.tip|ct|Quina ser&iacute;a la nostra motivaci&oacute; per enviar aquest document de feedback",
            "alpadre.introduccion.titulo|ct|Introducci&oacute;",
            "alpadre.propuesta.tip|ct|Quina és la proposta a enirprendre en compta pel grup pare",
            "alpadre.propuesta.titulo|ct|Proposta",
            "alpadre.situacionactual.tip|ct|Descrigui la situaci&oacute; actual general",
            "alpadre.situacionactual.titulo|ct|Situaci&oacute; actual",
            "alpadre.situaciondeseada.tip|ct|Descrigui la situaci&oacute; desitjada que volem veure considerada pel grup pare",
            "alpadre.situaciondeseada.tip|ct|Situaci&oacute; desitjada",
            "Aspectos logisticos|ct|Aspectes log&iacute;stics",
            "Autor de la publicacion|ct|Autor de la publicaci&oacute;",
            "Cancelar|ct|Cancel&middot;lar",
            "Cantidad de flores|ct|La Quantitat de flors ha d'estar entre 1 i 20",
            "Capacidaddes|ct|Capacitats",
            "Cerrar|ct|Tancar",
            "Comentarios|ct|Comentaris",
            "Comunicado al grupo padre|ct|Comunicat al grup pare",
            "Consecuencias|ct|Conseqü&egrave;ncies",
            "Consenso alcanzado|ct|Decisi&oacute; aconseguida",
            "Crea la propuesta|ct|Crea la proposta",
            "Crear|ct|Crear",
            "Modificar|ct|Modificar",
            "Eliminar|ct|Eliminar",
            ...
            "Definir apertura|ct|Definir obertura",
            "Definir evaluacion|ct|Definir evaluaci&oacute;",
            "Definir orden del dia|ct|Definir ordre del dia",
            "Definir un titulo de Acta|ct|Definir un t&iacute;tul d'Acta",
            "Documento de comunicado a evaluar|ct|Document de comunicat a evaluar",
            "Documento de resultado a evaluar|ct|Documento de resultat a evaluar",
            ...
            "El usuario no existe|ct|L'usuari no existeix",
            "El usuario no existe o no esta habilitado|ct|L'usuari no existeix o no est&atilde; habilitat",
            "Eliminar estrategia|ct|Eliminar estrategia",
            "Eliminar grupo de trabajo|ct|Eliminar grup de treball",
            "enlace.evaluacion.p1|ct|&iquest;La tem&atilde;tica est&atilde; molt relacionada amb els nostres obgetius? Si és que si, &iquest;De quina; manera?",
            "enlace.evaluacion.p2|ct|&iquest;S'ha tractat, o s'est&atilde; tractant aquesta tem&atilde;tica en el grup?",
            "enlace.evaluacion.p3|ct|&iquest;La tem&atilde;tica hauria d'integrar-se en els nostres obgetius? Si és que si, &iquest;Per qu&egrave;?",
            "enlace.evaluacion.p4|ct|&iquest;La tem&atilde;tica es obligar&atilde; a revisar els nostres obgetius?",
            "enlace.evaluacion.p5|ct|&iquest;Creus que aquest tema hauria de generar un nou cicle d'acci&oacute;? Si és que si, &iquest;Per qu&egrave;?",
            "enlace.evaluacion.tip1|ct|Eval&uacute;a si aquesta tem&atilde;tica est&atilde; en la linea dels interessos del grup i si pot o no aportar informaci&oacute;",
            "enlace.evaluacion.tip2|ct|Eval&uacute;a si aquesta tem&atilde;tica es pot considerar sòlida i veraç",
            "enlace.evaluacion.tip3|ct|Eval&uacute;a si consideres que aquesta tem&atilde;tica facilita l'abast dels nostres objectius",
            "enlace.evaluacion.tip4|ct|Eval&uacute;a si consideres que aquesta tem&atilde;tica pot arribar a cambiar els nostres objectius",
            "enlace.evaluacion.tip5|ct|Eval&uacute;a si consideres que aquesta tem&atilde;tica hauria de provocar accions reals en el grup",
            "Enseña vista previa antes de proponer|ct|Ensenya vista pr&egrave;via abans de proposar",
            "aclaracion|ct|Aclariment",
            ...
            "Evaluacion caida para el tema [%1]|ct|Evaluaci&oacute; caiguda pel tema [%1]",
            "Evaluacion de Accion|ct|Evaluaci&oacute; d'Acci&oacute;",
            "Evaluación de Accion|ct|Evaluaci&oacute; d'Acci&oacute;",
            "Evaluacion de comunicado intergrupal|ct|Evaluaci&oacute; de comunicat intergrupal",
            "Evaluacion de Enlace|ct|Evaluaci&oacute; d'Enllaç",
            "Evaluacion de Evento|ct|Evaluaci&oacute; d'Esdeveniment",
            "evento.aquien.tip|ct|A qui va dirigit l'Esdeveniment i qui es beneficiar&atilde; amb els resultats",
            "accion.revision.titulo|ct|Revisi&oacute;n",
            "Presente|ct|Present",
            "NO presente|ct|NO present",
            "Pertenece al grupo|ct|Pertany al grup",
            "NO Pertenece al grupo|ct|No pertany al grup",
            "Revision de valoracion del resultado|ct|Revision de valoracion de l'resultat",
            "evento.aquien.titulo|ct|A qui va dirigit",
            "evento.creado|ct|Esdeveniment creat",
            "evento.descripcion.tip|ct|Descriu como seria; l'Esdeveniment. &iquest;show? &iquest;presentacions? &iquest;ponents? &iquest;música? &iquest;activitats? &iquest;pallassos? &iquest;catering?",
            "evento.descripcion.titulo|ct|Descripci&oacute;",
            "evento.error|ct|Error",
            "evento.evaluacion.p1|ct|&iquest;Creus que aquest Esdeveniment ha facilitat el desenvolupament dels nostres objectius? Si no, &iquest;por qu&egrave;?",
            "evento.evaluacion.p2|ct|&iquest;Hem apr&egrave;s algo nou de la experi&egrave;ncia? Si és que si, qu&egrave;; ha estat? Si és que no, &iquest;Qu&egrave;; creus que ha frenat el nostre procés d'aprenentatge?",
            "evento.evaluacion.p3|ct|&iquest;T'has sentit segur, incloent, copartícep durant el procés? si no, &iquest;Per qu&egrave;?",
            "evento.evaluacion.p4|ct|&iquest;Les fases, costos, recursos i terminis han estat els adequats? Si no, &iquest;per qu&egrave;?",
            "evento.evaluacion.p5|ct|&iquest;Creus que la persona que ha coordinat el procés ha estat conseqüent amb el seu rol? Si no, &iquest;per qu&egrave;?",
            "evento.evaluacion.p6|ct|&iquest;Creus que el resultat d'aquesta evaluaci&oacute; ha de generar un ajust dels nuestres objectius? Si és que si, &iquest;Per qu&egrave;",
            "evento.evaluacion.tip1|ct|Evalua si l'Esdeveniment era necessari como s'havia definit al prendre la decisi&oacute;",
            "evento.evaluacion.tip2|ct|Evalua si l'objectiu definit per l'Esdeveniment finalment es correspon amb el resultat obtingut",
            "evento.evaluacion.tip3|ct|Evalua si t'has sentit segur,incloent i copartícep del procés executiu",
            "evento.evaluacion.tip4|ct|Evalua si las fases, costos, recursos i terminis definits al prendre la decis&oacute; eren adequades",
            "evento.evaluacion.tip5|ct|Evalua si la persona que ha coordinat el procés, ho feu adequadament",
            "evento.evaluacion.tip6|ct|Evalua si consideres necessari realitzar un altre cicle de debat i acci&oacute; tenient en compta el resultat obtingut",
            "evento.fecha.tip|ct|Fes una proposta de data per l'Esdeveniment",
            "evento.fecha.titulo|ct|Fes una proposta de data per l'Esdeveniment",
            "evento.introduccion.tip|ct|&iquest;Quina és la situaci&oacute; que requereix d'aquesta proposta d'Esdeveniment? &iquest;perqu&egrave;; s'ha de fer? &iquest;Quina és la motivaci&oacute;? Tingues en compte que la situati&oacute; que descrius representi al grup",
            "evento.introduccion.titulo|ct|Introducci&oacute;",
            "evento.lugar.tip|ct|Descriu els recursos que seran necessaris sense oblidar un pressupost estimat",
            "evento.lugar.titulo|ct|Lloc",
            "evento.recursos.tip|ct|Descriu els recursos que seran necesaris sense oblidar un pressupost estimat",
            "evento.recursos.titulo|ct|Recursos",
            "evento.objetivo.tip|ct|Descriu que pretens que aconseguim realitzant aquest Esdeveniment. Motiva al grup amb aquest objectiu. &iquest;és un desitg del grup aconseguir-lo?",
            "evento.objetivo.titulo|ct|Objectiu a aconseguir",
            "evento.organizacion.tip|ct|Descriu com s'ha d'organitzar aquest Esdeveniment, passos a seguir, temps, desplaçaments, contractacions, etc.",
            "evento.organizacion.titulo|ct|Organitzaci&oacute;",
            "evento.responsable.tip|ct|Suggereix un responsable",
            "evento.responsable.titulo|ct|Responsable",
            "evento.transportes.tip|ct|Descriu els recursos que seran necessaris sense oblidar un pressopost estimat. Software, desplaçaments, serveis, etc.",
            "evento.transportes.titulo|ct|Transports",
            "evento.valoracion.tip|ct|&iquest;Com es mesurar&atilde;; el resultat d'aquest Esdeveniment? &iquest;entrades venudes? &iquest;quantitat de persones presents? &iquest;reconeixement assolit? &iquest;efectes socials? &iquest;publicitat?. <br>La valoraci&oacute; de l'Esdeveniment ha de ser quantificable i f&atilde;cil de comprendre. Ha de quedar clar si ha anat bé o no.",
            "evento.valoracion.titulo|ct|Valoraci&oacute; del resultat",
            "Fecha|ct|Data",
            "Fecha celebracion|ct||Data celebraci&oacute;",
            "Fecha proxima celebracion|ct|Data pròxima celebraci&oacute;",
            "Grupo hijo borrado|ct|Grup fill borrat",
            "SubGrupo.actualizado.tip|ct|Grup de treall actualitzat en l'estructura organitzativa",
            "SubGrupo.actualizado.titulo|ct|Grup de treall actualitzat en l'estructura organitzativa",
            "SubGrupo.aquien.tip|ct|Qui es beneficiar&atilde; amb els resultats",
            "SubGrupo.aquien.titulo|ct|A qui va dirigit",
            "SubGrupo.capacidades.tip|ct|&iquest;Quines; capacitats han de tenir les persones que componen el nou grup? Coneixements, experi&egrave;ncies, etc.",
            "SubGrupo.capacidades.titulo|ct|Capacitats necess&atilde;ries",
            "SubGrupo.conclusiones.tip|ct|&iquest;Qu&egrave; hem apr&egrave;s amb aquesta experi&egrave;ncia?",
            "SubGrupo.conclusiones.titulo|ct|Conclusions",
            "SubGrupo.consecuencias.tip|ct|&iquest;Quines són les conseqü&egrave;ncies d'eliminar aquest grup de treball que haur&atilde; d'enfrontar?",
            "SubGrupo.consecuencias.titulo|ct|Conseqü&egrave;ncies",
            "SubGrupo.creado.tip|ct|Grup de treball creat en l'estructura organitzativa",
            "SubGrupo.creado.titulo|ct|Grup de treball creat en l'estructura organitzativa",
            "SubGrupo.descripcion.tip|ct|Descriu breument les activitats a realitzar per assolir els objectius.",
            "SubGrupo.descripcion.titulo|ct|Descripci&oacute;",
            "SubGrupo.eliminado|ct|Grup de treball [%1] eliminat de l'estructura organitzativa",
            "SubGrupo.integrantes.tip|ct|&iquest;Qui seran els integrants del nou grup de treball? Aquests noms serveixen de proposta o refer&egrave;ncia. No impliquen realment a les persones. Si no vols implicar noms reals clica 'a definir'.",
            "SubGrupo.integrantes.titulo|ct|Integrants",
            "SubGrupo.introduccion.tip|ct|&iquest;Quina és la situaci&oacute; actual?, &iquest;Per qu&egrave; necessitem un nou grup de treball?, &iquest;Quins problemes resoldré? Tingues en compte que la situati&oacute; que descrius representi al grup",
            "SubGrupo.introduccion.titulo|ct|Introducci&oacute;",
            "SubGrupo.objetivo.tip|ct|&iquest;Quins són els objectius del nou grup de treball?",
            "SubGrupo.objetivo.titulo|ct|Objectius a assolir",
            "SubGrupo.recursos.tip|ct|&iquest;Quins recursos seran necessaris pel nou grup de treball? Mobiliari, ordenadors, lloc de treball, etc.",
            "SubGrupo.recursos.titulo|ct|Recursos",
            "SubGrupo.revision.tip|ct|&iquest;Amb quina periodicitat han d'evaluar-se els resultats assolits.",
            "SubGrupo.revision.titulo|ct|Revisi&oacute; de valoraci&oacute; del resultat",
            "SubGrupo.valoracion.tip|ct|&iquest;Com es medir&atilde; el resultat d'aquest grup de traball? &iquest;quantitat de processos executats? &iquest;m&egrave;triques d'efici&egrave;ncia? &iquest;reconeixement d'atres persones? &iquest;resultats concrets?. <br>La valoraci&oacute; de l'acompliment del grup ha de ser quantificable i f&atilde;cil de comprendre. Ha de quedar clar per tots si cumpleix amb el seu objectiu o no.",
            "SubGrupo.valoracion.titulo|ct|Valoraci&oacute; del resultat",
            "Integrantes|ct|Integrants",
            ...
            "La evaluacion anterior ha sido reemplazada|ct|La evaluaci&oacute;<br> anterior ha estat<br> reemplaçada",
            ...
            "manifiesto.mision.tip|ct|La missi&oacute; defineix quina &eacute;s la nostra feina, qu&egrave; fem?, a qu&egrave; ens dediquem?, en quin sector social succeeix?, qui &eacute;s el nostre p&uacute;blic objectiu?, quin &eacute;s el nostre &agrave;mbit geogr&agrave;fic d'actuaci&oacute;?",
            "manifiesto.mision.tip|ct|Missi&oacute;",
            "manifiesto.objetivos.tip|ct|Els objectius concreten la missi&oacute;, ens donen un sentit de temporalitat. Han de fer apar&egrave;ixer la relaci&oacute; de benefíci mutu entre la organizaci&oacute; i el seu entorn.",
            "manifiesto.objetivos.titulo|ct|Objectius",
            ...
            "No hay grupos hijos en este grupo|ct|No hi ha grups fills en aquest grup",
            "No tiene flores para crear una propuesta|ct|No tens flors per a crear una proposta",
            "Nombre|ct|Nom",
            "Nombre de la publicacion|ct|Nom de la publicaci&oacute;",
            "Nombre de nodo no puede ser vacio|ct|Nom de node no pot ser buit",
            "Nueva Acta publicada|ct|Nova Acta publicada",
            "Nueva decision [%1]|ct|[%1] Decisi&oacute; assolida",
            "Nuevo grupo hijo agregado|ct|Nou grup filla agregat",
            "Organizacion|ct|Organitzaci&oacute;",
            "Palabras clave|ct|Paraules clau",
            "Participantes|ct|Participants",
            "Permite corregir errores|ct|Permet corregir errors",
            "Prevista de evaluacion|ct|Vista Pr&egrave;via d'evaluació",
            "Prevista de propuesta|ct|Vista Pr&egrave;via de proposta",
            "proceso.aquien.tip|ct|Qui es beneficiar&atilde; amb els resultats d'utilitzar aquesta estrat&egrave;gia",
            "proceso.aquien.titulo|ct|A qui va dirigit",
            "proceso.conclusiones.tip|ct|&iquest;Qu&egrave; hem apr&egrave;s amb aquesta experi&egrave;ncia?",
            "proceso.conclusiones.titulo|ct|Conclusions",
            "proceso.consecuancias.tip|ct|&iquest;Quines són les conseqü&egrave;ncies d'eliminar aquest grup de treball que haur&atilde; d'afrontar?",
            "proceso.consecuancias.titulo|ct|&iquest;Quines són les conseqü&egrave;ncies d'eliminar aquest grup de treball que haur&atilde; d'afrontar?",
            "proceso.definicion.tip|ct|Defineix pas a pas les tasques a realitzar quan s'executi aquest procés. Defineix com es tractaran les excepcions. Una estrategia es un fluxe de condicions i tasques que contempla totes les alternatives possibles de manera que la seva execuci&oacute; no admeti discussions sobre els seus resultats. Un procés operatiu ben definit és part important de la definici&oacute; operativa del grup. Totes les activitats habituals del grup han de definir-se com a processos operatius.",
            "proceso.definicion.titulo|ct|Definici&oacute; de l'estrat&egrave;gia",
            "proceso.descripcion.tip|ct|Descriu breument els passos a realitzar per utlitzar aquesta estrat&egrave;gia. Menciona com es tractaran els casos excepcionals. Una estrat&egrave;gia sempre ha de generar un resultat, encara que sigui un registre d'error per la seva posterior an&atilde;lisis.",
            "proceso.descripcion.titulo|ct|Descripci&oacute;",
            "proceso.entradas.tip|ct|&iquest;Com es provoca l'execuci&oacute; d'aquest procés? &iquest;Qu&egrave; necessita aquest procés per poder executar-se? Un nou soci, un document, una petició personal, etc.",
            "proceso.entradas.titulo|ct|Entrades de procés",
            "proceso.grupo.tip|ct|&iquest;Quin grup de treball utilitza aquesta estrat&egrave;gia?",
            "proceso.grupo.titulo|ct|Grup de treball",
            "proceso.implantacion.tip|ct|&iquest;Qu&egrave; s'ha de fer per implementar aquest procés? Recursos, lloc físic, coneixements i capacitats de les persones, formularis/fulles de dades/butlletins informatius, software, etc.",
            "proceso.implantacion.titulo|ct|Implantaci&oacute;",
            ...
            "proceso.introduccion.titulo|ct|Introducci&oacute;",
            "proceso.objetivo|ct|Quins s&oacute;n els objectius del nou grup de treball?",
            "proceso.objetivo.tip|ct|Quin sería l'objecctiu de crear una nova estrat&egrave;gia",
            "proceso.objetivo.titulo|ct|Objectiu",
            "proceso.revision.tip|ct|&iquest;Quan es revisar&atilde;; la definici&oacute; d'aquesta estrat&egrave;gia?",
            "proceso.revision.titulo|ct|Revisi&oacute; de valoraci&oacute; del resultat",
            "proceso.valoracion.tip|ct|&iquest;Com es medir&atilde; el resultat d'aquesta estrat&egrave;gia? &iquest;Qantitat de procesos executats? &iquest;resultats obtinguts? &iquest;facilita la necessitat? &iquest;és f&atilde;cil d'executar?. <br>La valoraci&oacute; d'un procés operatiu ha de ser quantificable i f&atilde;cil de comprendre. Ha de quedar clar per a tots si cumpleix amb el seu objectiu o no.",
            "proceso.valoracion.titulo|ct|Valoraci&oacute; del resultat",
            "Proponer variante|ct|Proposar variant",
            "Recursos|ct|Recursos",
            "Representante|ct|Representant",
            "Representantes|ct|Representants",
            "Revisar evaluacion|ct|Revisar",
            "Revisar propuesta|ct|Revisar",
            "Se deben definir los participantes|ct|S'han de definir els participants",
            "Seleccione un nodo|ct|Seleccioni un node",
            "Simulacion|ct|Simulació!!!",
            "tema|ct|Tema",
            "tema|ct|Tema",
            "Titulo|ct|T&iacute;tol",
            "URL de la publicacion|ct|URL de la publicaci&oacute;",
            "Usuario [%1] actualizado|ct|Usuari [%1] actualitzat",
            "Usuario [%1] borrado|ct|Usuari [%1] borrat",
            "Usuario invalido|ct|Usuari inv&atilde;lid, operaci&oacute; registrada!",
            "Usuario no habilitado|ct|Usuari no habilitat pel grup [%1]",
            "Usuario o clave incorrectos|ct|Usuari o clau incorrectes pel grup [%1]",
            "Usuarios creados desahibilitados|ct|Usuaris creats a [%1] deshabilitats, contacta el coordinador per a habilitar-les",
            "Vision|ct|Visi&oacute;",
            "manifiesto.vision.titulo|ct|Visió",
            "manifiesto.mision.titulo|ct|Missió",
            "evento.aquien.tip|ct|A qui va dirigit l'Esdeveniment i qui es beneficiar&atilde; amb els resultats",
            "Comunicado del grupo|ct|Comunicat de el grup",
            "Al grupo padre|ct|A el grup pare",
            "alpadre.situaciondeseada.titulo|ct|Situació desitjada",
            "Al grupo hijo|ct|A el grup fill",        
            "manifiesto.consensoMsg|ct|El manifest ha estat aprovat <br>i aquesta visible en estructures",
            "accion.consensoMsg|ct|El projecte d'acci&otilde; ha estat creat <br>i est&atilde; disponible en el seguiment",
            ...
            "estrategia.consensoMsg|ct|S'ha aprovat l'actualitzaci&oacute; d'una estrat&egrave;gia de grup <br>i ja est&atilde; disponible a les estructures",
            "evento.consensoMsg|ct|S'ha aprovat un nou esdeveniment <br>i ja est&atilde; disponible en el seguiment",
            "subGrupo.consensoMsg|ct|S'ha aprobado l'actualizacion d'un subgrup <br>i ja est&atilde; disponible en les estructures",
            "Fallo al enviar el mail|ct|Decisi&oacute; a l'enviar el mail: ",
            "El mail del coordinador es incorrecto|ct|El mail del coordinador &eeacute;s incorrecte: ",
            "Sobre la publicacion|ct|Sobre la publicaci&oacute;",
            "modeloDocumento.Accion|ct|Acci&oacute;",
            "modeloDocumento.Acta|ct|Acta",
            "modeloDocumento.AlHijo|ct|GrupConcret",
            "modeloDocumento.AlPadre|ct|GrupGeneral",
            "modeloDocumento.Circular|ct|Circular",
            "modeloDocumento.Didactico|ct|Did&aacute;ctic",
            "modeloDocumento.Estrategia|ct|Estrat&egrave;gia",
            "modeloDocumento.Evento|ct|Esdeveniment",
            "modeloDocumento.Manifiesto|ct|Manifest",
            "modeloDocumento.SubGrupo|ct|Subgrup",
            "modeloEvaluacion.Accion|ct|Acci&oacute;",
            "modeloEvaluacion.AlHijo|ct|GrupConcret",
            "modeloEvaluacion.AlPadre|ct|GrupGeneral",
            "modeloEvaluacion.Enlace|ct|Enlace",
            "modeloEvaluacion.Evento|ct|Evento",
            ...
            "SubGrupo.eliminado|en|Workgroup [%1] removed from the organizational structure",
            ...
            "Fallo al enviar el mail|en|Failed to send the email: ",
            "El mail del coordinador es incorrecto|en|The coordinator's email is incorrect: ",
            "Sobre la publicacion|en|About the publication",
            "modeloDocumento.Accion|en|Action",
            "modeloDocumento.Acta|en|Minute",
            "modeloDocumento.AlHijo|en|ConcreteGroup",
            "modeloDocumento.AlPadre|en|GeneralGroup",
            "modeloDocumento.Circular|en|Circular",
            "modeloDocumento.Didactico|en|Didactic",
            "modeloDocumento.Estrategia|en|Strategy",
            "modeloDocumento.Evento|en|Event",
            "modeloDocumento.Manifiesto|en|Manifest",
            "modeloDocumento.SubGrupo|en|Subgroup",
            "modeloEvaluacion.Accion|en|Action",
            "modeloEvaluacion.AlHijo|en|ConcreteGroup",
            "modeloEvaluacion.AlPadre|en|GeneralGroup",
            "modeloEvaluacion.Enlace|en|Link",
            "modeloEvaluacion.Evento|en|Event",
            ...
            "SubGrupo.eliminado|fr|Groupe de travail [%1] &eacute;limin&eacute; de la structure organisationnelle",
            ...
            "Fallo al enviar el mail|fr|Impossible d'envoyer l'e-mail: ",
            "Sobre la publicacion|fr|&Agrave; propos de la publication",
            "El mail del coordinador es incorrecto|fr|L'email du coordinateur est incorrect: ",
            "modeloDocumento.Accion|fr|Action",
            "modeloDocumento.Acta|fr|Enregistrer",
            "modeloDocumento.AlHijo|fr|Groupe sp&eacute;cifique",
            "modeloDocumento.AlPadre|fr|Groupe g&eacute;n&eacute;ral",
            "modeloDocumento.Circular|fr|Circulaire",
            "modeloDocumento.Didactico|fr|Didactique",
            "modeloDocumento.Estrategia|fr|Strat&eacute;gie",
            "modeloDocumento.Evento|fr|&Eacute;v&eacute;nement",
            "modeloDocumento.Manifiesto|fr|Manifeste",
            "modeloDocumento.SubGrupo|fr|Sous-groupe",
            "modeloEvaluacion.Accion|fr|Action",
            "modeloEvaluacion.AlHijo|fr|Groupe sp&eacute;cifique",
            "modeloEvaluacion.AlPadre|fr|Groupe g&eacute;n&eacute;ral",
            "modeloEvaluacion.Enlace|fr|Lien",
            "modeloEvaluacion.Evento|fr|&Eacute;v&eacute;nement",
        };
        ...
        public static string sendMailAlta(Grupo grupo, string to, string nombre, string email, string basepath)
        {
            ...
            return sendMail(to, "Solicitud de alta en [" + grupo.nombre + "]", msg, grupo.idioma);
        }
        ...
        public static string sendMailWelcome(Grupo grupo, string to, string clave, string url, string basepath)
        {
            ...
            return sendMail(to, "Alta Nabú", msg, grupo.idioma);
        }

        public static string sendMail(string to, string subject, string body, string idioma)
        {
            //envio por mail
            ...
            if (SMTPURL != "")
            {
                try
                {
                    ...
                    {
                        throw new Exception(Tools.tr("El mail del coordinador es incorrecto", idioma) + ex.Message);
                    }
                    ...
                    {
                        throw new Exception(Tools.tr("Fallo al enviar el mail", idioma) + ex.Message);
                    }
                }
                catch (Exception ex)
                {
