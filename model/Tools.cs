...
namespace nabu
{
    ...
    public static class Tools
    {
        ...
        public static List<string> dictionary = new List<string>() {
            ...
            "grupoTrabajo.introduccion.tip|es|&iquest;Cual es la sicuaci&oacute;n actual?, &iquest;Por qu&eacute; necesitamos un nuevo grupo de trabajo?, &iquest;Qu&eacute; problemas resolver&aacute;? Ten en cuenta que la situati&oacute;n que describes represente al grupo",
            ...
            "proceso.introduccion.titulo|es|&iquest;Cual es la sicuaci&oacute;n actual?, &iquest;Por qu&eacute; necesitamos una nueva estrategia?, &iquest;Qu&eacute; problemas resolver&aacute;? Ten en cuenta que la situati&oacute;n que describes represente un problema real del grupo",
            ...
            "accion.evaluacion.p1|fr|Croyez-vous que notre action concr&egrave;te &agrave; facilit&eacute; le d&eacute;veloppement de nos buts? Si non, pourquoi?",
            ...
            "accion.materiales.tip|fr|D&eacute;crivez les ressources n&eacute;cessaires sans oublier un devis estimatif.",
            "accion.materiales.titulo|fr|Mat&eacute;riels",
            ...
            "Crear evaluacion|fr|Cr&eacute;er &eacute;valuation",
            ...
            "Crear propuesta|fr|Cr&eacute;e proposition",
            ...
            "Enseña vista previa antes de proponer|fr|Monter l&#x2019;aper&ccedil;u avant de proposer",
            "Enviar|fr|Envoyer",
            ...
            "evento.evaluacion.p5|fr|Croyez-vous que la personnes qui a dirig&eacute; le processus d&#x2019;ex&eacute;cution a agit en cons&eacute;quence de son r&ocirc;le? Si non, pourquoi?",
            ...
            "evento.fecha.tip|fr|Faite une proposition de date pour l'&eacute;v&eacute;nement",
            ...
            "evento.lugar.titulo|fr|Lieu",
            "evento.materiales.tip|fr|D&eacute;crivez les ressources n&eacute;cessaires sans oublier d'ajouter un devis estimatif.",
            "evento.materiales.titulo|fr|Mat&eacute;riels",
            ...
            "grupoTrabajo.actualizado.tip|fr|Groupe de travail actualis&eacute; dans la structure organisationnelle",
            "grupoTrabajo.actualizado.titulo|fr|Groupe de travail actualis&eacute; dans la structure organisationnelle",
            "grupoTrabajo.aquien.tip|fr|Qui va se b&eacute;n&eacute;ficier des r&eacute;sultats",
            "grupoTrabajo.aquien.titulo|fr|Vers qui cela est orient&eacute;",
            "grupoTrabajo.capacidades.tip|fr|Quelles aptitudes doivent avoir les personnes qui composent ce groupe de travail? Connaissances, exp&eacute;riences, etc.",
            "grupoTrabajo.capacidades.titulo|fr|Aptitudes n&eacute;cessaires",
            "grupoTrabajo.conclusiones.tip|fr|Qu'avons-nous apprit de l'exp&eacute;rience?",
            "grupoTrabajo.conclusiones.titulo|fr|Conclusions",
            "grupoTrabajo.consecuencias.tip|fr|Quelles seront les cons&eacute;quences si nous supprimons ce groupe de travail.",
            "grupoTrabajo.consecuencias.titulo|fr|Cons&eacute;quences",
            "grupoTrabajo.creado.tip|fr|Groupe de travail cr&eacute;&eacute; dans la structure organisationnelle",
            "grupoTrabajo.creado.titulo|fr|Groupe de travail cr&eacute;&eacute; dans la structure organisationnelle",
            "grupoTrabajo.descripcion.tip|fr|D&eacute;crivez bri&egrave;vement les activit&eacute;s &agrave; r&eacute;aliser pour atteindre les buts.",
            "grupoTrabajo.descripcion.titulo|fr|Description",
            "grupoTrabajo.eliminado.tip|fr|Groupe de travail &eacute;limin&eacute; de la structure organisationnelle",
            "grupoTrabajo.eliminado.titulo|fr|Groupe de travail &eacute;limin&eacute; de la structure organisationnelle",
            "grupoTrabajo.integrantes.tip|fr|Qui seront les membres de ce nouveau groupe de travail? Ces noms servent comme proposition ou r&eacute;f&eacute;rence. Cela n'implique pas vraiment aux personnes. Si vous ne voulez pas utiliser les noms r&eacute;elles dites &quot;&agrave; d&eacute;finir&quot;.",
            "grupoTrabajo.integrantes.titulo|fr|Membres",
            "grupoTrabajo.introduccion.tip|fr|Quelle est la situation actuelle? Pourquoi avons-nous besoin d'un nouveau groupe de travail? Quels probl&egrave;mes cela va r&eacute;soudre? Prenez en compte que la situation repr&eacute;sente &agrave; l'&eacute;quipe.",
            "grupoTrabajo.introduccion.titulo|fr|Introduction",
            "grupoTrabajo.objetivo.tip|fr|Quels sont les buts du nouveau groupe de travail?",
            "grupoTrabajo.objetivo.titulo|fr|But &agrave; atteindre",
            "grupoTrabajo.recursos.tip|fr|Quelles seront les ressources n&eacute;cessaires pour nouveau groupe de travail? Mobilier, terminaux informatiques, espaces de travail, etc.",
            "grupoTrabajo.recursos.titulo|fr|Ressources",
            "grupoTrabajo.revision.tip|fr|Quelle serait la fr&eacute;quence d'&eacute;valuation des r&eacute;sultats obtenus?",
            "grupoTrabajo.revision.titulo|fr|R&eacute;vision &eacute;valuation des r&eacute;sultats",
            "grupoTrabajo.valoracion.tip|fr|Comment va-t'on mesurer le r&eacute;sultat de ce groupe de travail? Quantit&eacute; de processus ex&eacute;cut&eacute;? M&eacute;triques d'efficience? Reconnaissance d'autre personnes? R&eacute;sultats concrets?<br/>La mise en valeur des r&eacute;sultats de l'&eacute;quipe doit &ecirc;tre quantifiable et facile &agrave; comprendre. Cela doit &ecirc;tre claire pour tous si le but a &eacute;t&eacute; accompli, ou pas.",
            "grupoTrabajo.valoracion.titulo|fr|&Eacute;valuation du resultat",
            ...
            "manifiesto.vision.tip|fr|La vision doit inspirer et motiver l'organisation et ses groupes. Quelle est notre vision du monde? Quel est ce meilleur futur pour le plus grand nombre voyons-nous?",
            "max|fr|Max",
            ...
            "Prevista de evaluacion|fr|pr&eacute;vue d'&eacute;valuation",
            "Prevista de propuesta|fr|pr&eacute;vue de proposition",
            ...
            "proceso.introduccion.titulo|fr|Quelle est la situation actuelle? Pourquoi avons-nous besoin d'une nouvelle strat&eacute;gie? Quels probl&egrave;mes cela va-t'il r&eacute;soudre? Prenez en compte que la situation que vous d&eacute;crivez repr&eacute;sente l'&eacute;quipe.",
            ...
            "Revisar evaluacion|fr|R&eacute;viser l&#x2019;&eacute;valuation",
            "Revisar propuesta|fr|R&eacute;viser proposition",
